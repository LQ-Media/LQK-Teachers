...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-[calc(var(--tabbar-h)+0.75rem)] z-50 mx-auto max-w-md rounded-card border-[0.5px] border-line bg-white p-3.5 shadow-[0_12px_40px_rgba(74,51,64,0.18)] sm:inset-x-auto sm:right-4 lg:bottom-3">
