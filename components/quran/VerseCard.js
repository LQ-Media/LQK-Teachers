...
function AyahMedallion({ number }) {
  ...
  return (
    <span
      className="mx-1 inline-flex h-[30px] w-[30px] -translate-y-0.5 items-center justify-center rounded-full border-[1.5px] border-gold/70 align-middle font-semibold text-[#8C7AA8]"
