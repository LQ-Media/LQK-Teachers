...
export default function PackBuilder({ surahs, canGenerate }) {
  ...
  return (
    <div className="rounded-card border border-line bg-white p-6 shadow-[0_1px_3px_rgba(59,55,43,0.04)]">
      ...
      {error && (
        <div className="mb-4 flex items-start gap-2.5 rounded-control bg-rust-soft px-4 py-3 text-[13px] text-[#8E3A24]">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-control bg-ink px-5 py-2 text-[13px] font-bold text-paper shadow-[0_4px_12px_rgba(59,55,43,0.24)] transition-colors hover:bg-ink-deep disabled:cursor-not-allowed disabled:opacity-50"
        >
