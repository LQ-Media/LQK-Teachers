...
export default async function PackPage({ params }) {
  ...
  return (
    <div className="px-4 py-6 sm:p-8 max-w-3xl">
      ...
      {row.status === "draft" && (
        <div className="mb-5 flex items-start gap-2.5 rounded-control bg-rust-soft px-4 py-3 text-[13px] text-[#8E3A24]">
      ...
      {pack.objective && (
        <p className="mt-6 rounded-card border-[0.5px] border-line bg-gradient-to-br from-white to-[#FDF8EE] p-5 text-[14px] leading-relaxed text-charcoal">
      ...
      {pack.uncertain.length > 0 && (
        <div className="mt-6 rounded-card border border-[#EED4C2] bg-rust-soft p-5">
          <div className="mb-2 flex items-center gap-2">
            ...
            <h2 className="font-heading text-[15px] font-bold text-[#8E3A24]">Check before teaching</h2>
          </div>
