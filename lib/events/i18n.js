...
const STRINGS = {
  en: {
    ...
    inviteLine: "We would like to invite you to",
    hostedBy: "Hosted by",
    when: "When",
    where: "Where",
    ...
    contribTitle: "Supporting this event",
    contribRequired: "Required",
    contribBody:
      "Every attending family contributes towards the running of this event — the venue, the refreshments and the hands behind it. Your reply is complete once checkout is confirmed.",
    contribChoose: "Choose your contribution",
    ...
    contribPendingNote:
      "Your reply is saved. We're waiting for the store to confirm your payment — this page updates on its own.",
    contribOpenCheckout: "Open the checkout",
    contribRecheck: "I've paid — check again",
    contribChecking: "Checking…",
    contribStillPending:
      "The store hasn't confirmed the payment yet. It can take a minute — your reply is safe either way.",
    contribPendingSmall:
      "Keep this page open. If you closed the checkout, use the button above to reopen it.",
    ...
    registerBody:
      "Passing this majlis on to someone? This link is open to anyone — it isn't tied to your family's reply.",
    registerCta: "Open the registration page",
    aboutYou: "A few more details",
    aboutEveryone: "About everyone coming",
    personAdult: "Adult {n}",
    personChild: "Child {n}",
    optional: "optional",
    ...
    uploading: "Uploading…",
    uploaded: "Uploaded",
    uploadFailed: "That image didn't upload — please try again.",
    driveNotConfigured: "That image didn't upload — please try again.",
    fieldRequired: "Please answer everything marked required.",
    fieldBadChoice: "Please choose one of the options listed.",
    fieldBadNumber: "Please enter a number.",
    fieldBadDate: "Please enter a valid date.",
    fieldBadPhone: "That doesn't look like a usable phone number.",
    fieldBadEmail: "That doesn't look like an email address.",
    error: "Something went wrong. Please try again.",
  },
  ms: {
    salam: "Assalamu'alaikum",
    inviteLine: "Kami ingin menjemput anda ke",
    ...
    contribTitle: "Menyokong majlis ini",
    contribRequired: "Wajib",
    contribBody:
      "Setiap keluarga yang hadir menyumbang bagi menampung perjalanan majlis ini — tempat, jamuan dan tenaga yang mengendalikannya. Jawapan anda lengkap setelah pembayaran disahkan.",
    contribChoose: "Pilih sumbangan anda",
    ...
    contribPendingNote:
      "Jawapan anda telah disimpan. Kami menunggu kedai mengesahkan pembayaran — halaman ini dikemas kini sendiri.",
    contribOpenCheckout: "Buka pembayaran",
    contribRecheck: "Saya sudah bayar — semak semula",
    contribChecking: "Menyemak…",
    contribStillPending:
      "Kedai belum mengesahkan pembayaran. Ia mungkin mengambil seminit — jawapan anda tetap selamat.",
    contribPendingSmall:
      "Biarkan halaman ini terbuka. Jika anda menutup halaman pembayaran, guna butang di atas untuk membukanya semula.",
    ...
    registerBody:
      "Ingin berkongsi majlis ini dengan orang lain? Pautan ini terbuka untuk sesiapa sahaja — ia tidak terikat dengan jawapan keluarga anda.",
    registerCta: "Buka halaman pendaftaran",
    aboutYou: "Beberapa butiran lagi",
    aboutEveryone: "Tentang setiap yang hadir",
    personAdult: "Dewasa {n}",
    personChild: "Kanak-kanak {n}",
    optional: "pilihan",
    chooseFile: "Pilih gambar",
    changeFile: "Tukar gambar",
    uploading: "Memuat naik…",
    uploaded: "Dimuat naik",
    uploadFailed: "Gambar itu gagal dimuat naik — sila cuba lagi.",
    driveNotConfigured: "Gambar itu gagal dimuat naik — sila cuba lagi.",
    fieldRequired: "Sila jawab semua yang bertanda wajib.",
    fieldBadChoice: "Sila pilih salah satu pilihan yang disenaraikan.",
    fieldBadNumber: "Sila masukkan nombor.",
    fieldBadDate: "Sila masukkan tarikh yang sah.",
    fieldBadPhone: "Nombor telefon itu tidak dapat digunakan.",
    fieldBadEmail: "Itu tidak kelihatan seperti alamat e-mel.",
    error: "Sesuatu tidak kena. Sila cuba lagi.",
  },
  ar: {
    salam: "السلام عليكم",
    inviteLine: "يسعدنا دعوتكم إلى",
    hostedBy: "بدعوة من",
    when: "الموعد",
    where: "المكان",
    dressCode: "الزي",
    ...
    message: "رسالة لنا",
    contribTitle: "دعم هذا المجلس",
    contribRequired: "مطلوبة",
    contribBody:
      "تساهم كل عائلة حاضرة في تغطية تكاليف إقامة هذا المجلس — المكان والضيافة والأيدي القائمة عليه. يكتمل ردكم بعد تأكيد الدفع.",
    contribChoose: "اختاروا قيمة مساهمتكم",
    ...
    contribPendingNote:
      "حُفظ ردكم. ننتظر تأكيد الدفع من المتجر — تتحدث هذه الصفحة تلقائياً.",
    contribOpenCheckout: "فتح صفحة الدفع",
    contribRecheck: "لقد دفعت — تحقّقوا مرة أخرى",
    contribChecking: "جارٍ التحقق…",
    contribStillPending:
      "لم يؤكد المتجر الدفع بعد. قد يستغرق ذلك دقيقة — وردكم محفوظ على كل حال.",
    contribPendingSmall:
      "أبقوا هذه الصفحة مفتوحة. إذا أغلقتم صفحة الدفع، استخدموا الزر أعلاه لفتحها من جديد.",
    ...
    registerBody:
      "هل ترغبون في مشاركة هذا المجلس مع غيركم؟ هذا الرابط مفتوح للجميع، وهو غير مرتبط برد عائلتكم.",
    registerCta: "فتح صفحة التسجيل",
    aboutYou: "بعض التفاصيل الإضافية",
    aboutEveryone: "عن كل من سيحضر",
    personAdult: "بالغ {n}",
    personChild: "طفل {n}",
    optional: "اختياري",
    ...
    uploaded: "تم الرفع",
    uploadFailed: "لم تُرفع الصورة — يرجى المحاولة مرة أخرى.",
    driveNotConfigured: "لم تُرفع الصورة — يرجى المحاولة مرة أخرى.",
    fieldRequired: "يرجى الإجابة عن كل ما هو مطلوب.",
    fieldBadChoice: "يرجى اختيار أحد الخيارات المذكورة.",
    fieldBadNumber: "يرجى إدخال رقم.",
    fieldBadDate: "يرجى إدخال تاريخ صحيح.",
    fieldBadPhone: "رقم الهاتف هذا غير صالح.",
    fieldBadEmail: "هذا لا يبدو عنوان بريد إلكتروني.",
...
export function formatDeadline(iso, lang) {
  // A bare date ("2026-09-01") carries no time, so read it at midday Singapore
  // — far enough from either edge that no rounding can print the wrong day.
  const at = eventInstant(/^\d{4}-\d{2}-\d{2}$/.test(String(iso || "").trim()) ? `${iso}T12:00:00` : iso);
  if (!at) return "";
  const locale = { en: "en-SG", ms: "ms-MY", ar: "ar" }[lang] || "en-SG";
  try {
    return new Intl.DateTimeFormat(locale, {
