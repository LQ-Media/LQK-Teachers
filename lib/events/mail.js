...
const EMAIL_COPY = {
  en: {
    subject: (title) => `An invitation for you: ${title}`,
    salam: "Assalamu'alaikum",
    lead: "We would like to invite you to",
  ...
  ms: {
    subject: (title) => `Jemputan untuk anda: ${title}`,
    salam: "Assalamu'alaikum",
    lead: "Kami ingin menjemput anda ke",
  ...
  ar: {
    subject: (title) => `دعوة لكم: ${title}`,
    salam: "السلام عليكم",
    lead: "يسعدنا دعوتكم إلى",
