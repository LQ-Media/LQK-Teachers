...
/* WhatsApp delivery via Wati.
   ...
   The approved body (Karim's wording, 3 parameters):

     Assalamu'alaikum {{1}},

     You're invited to {{2}}.
     Please let us know if you can join us by clicking the link here:
     {{3}}

     _*Attendance is mandatory for all LQK students.*_

   ⚠️ Do NOT put a full stop directly after {{3}}. Several WhatsApp clients
