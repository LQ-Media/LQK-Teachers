...
/**
 * How late a clock-in may be before it is worth an IT Head's attention.
 *
 * Not a grace period: a late tap always costs the teacher those minutes,
 * whether it is 4 minutes or 40. This only decides what lands on the exception
 * list, so the weekly chase is about the shifts that actually went wrong rather
 * than about somebody who was three minutes behind a bus.
 *
