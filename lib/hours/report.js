...
/**
 * Group a month's shifts into the per-teacher blocks the payroll sheet uses.
 *
...
export function monthlyReport(shifts, month) {
  ...
  for (const shift of shifts || []) {
    ...
    if (month && sgMonth(shift.startsAt) !== month) continue;
...
/** Every flagged shift in the month, for the IT Heads' weekly chase. */
