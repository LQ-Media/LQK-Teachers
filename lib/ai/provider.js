...
- "commonMistakes": 2-4 specific errors children actually make on THESE ayat or these rules — pronunciation, not behaviour.
...
export function normalisePack(input, analysis) {
  ...
  return {
    ...
    tajweedFocus: focus,
    activities,
    commonMistakes: arr(obj.commonMistakes).map(str).filter(Boolean),
