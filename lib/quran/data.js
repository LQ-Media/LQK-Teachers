...
// Kemenag publishes with academic diacritics (ā ī ū ṣ ḍ ṭ ẓ ḥ ż); NU Online
// renders the very same text in pesantren glyphs (â î û sh dl th dh ḫ dz).
...
function toNuStyle(text) {
  let out = String(text || "");
  // Drop Kemenag's parenthesised waqf letters — "ḥasanā(n)." → "ḥasanā".
  out = out.replace(/\([a-zA-Zāīūâîû‘']{1,4}\)/g, "");
