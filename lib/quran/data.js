      ...
      return cached(key, async () => {
        ...
        for (;;) {
          ...
          for (const v of data.verses) {
            const entries = v.translations || [];
            const translit = entries.find((t) => t.resource_id === TRANSLITERATION_ID);
            const main = entries.find((t) => t.resource_id !== TRANSLITERATION_ID);
            verses.push({
              ...
              transliteration: translit ? stripHtml(translit.text) : "",
            });
          }
