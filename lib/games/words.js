...
/**
 * The English meaning of a drill word, or null when there is none recorded —
 * which is the normal case for the nonsense combinations and for anything not
 * yet checked against a dictionary.
 */
export function meaningOf(word) {
  const found = MEANINGS[word];
