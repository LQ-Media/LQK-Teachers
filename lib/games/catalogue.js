...
export const GAMES = [
  ...
  },
  {
    ...
    blurb:
      "Touch each letter in reading order and the syllables join into the whole word — the 12 printed cards, or three-letter words from the mushaf with their meaning.",
    sense: ["Touch", "Listen", "See"],
    icon: "layers",
    tone: "sage",
  },
