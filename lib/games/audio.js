...
function pickArabicVoice() {
  ...
  if (!synth) return (arabicVoice = null);
  const voices = synth.getVoices();
  // Voices arrive asynchronously in some browsers; an empty list here just
  // means "not yet", so it is not cached as a definitive no.
 ...
 * be pronounced.
 */
export async function sayLetter({ letterId, harakahId = null, arabic }) {
