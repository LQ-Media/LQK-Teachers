...
// 3D clay renders for the main headings — 512², real-world materials, cut out
// on transparency (see scripts/art/manifest.mjs). Every group now has one;
// keep this set in step with public/dzikir/, since a missing file would 404.
//
// Haji & Umrah is the Kaaba and Ziyarah is the Green Dome of Masjid an-Nabawi:
// both are drawn in their true colours and must never be recoloured to match a
// palette.
const GROUP_IMAGES = new Set([
  "wirid",
  "doa",
  "maulid",
  "haji-dan-umrah",
